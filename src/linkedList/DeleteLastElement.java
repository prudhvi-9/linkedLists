...
public class DeleteLastElement {
	...
	public Node addNode(int data) {
		/**
		 * Created New node. Check head is empty or not. If yes then assign head
		 * =newNode. Iterate the linkedList and reach at last node. Assign new node to
		 * the next part of last node of linked list. Return head.
		 */
	...
	/**
	 * To Delete a elements in the list.
	 * 
	 * @param data
	 */
